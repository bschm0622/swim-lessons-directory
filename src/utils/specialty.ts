...
export const SPECIALTIES: Record<string, SpecialtyConfig> = {
	'private-swim-lessons': {
		...
		icon: '/icons/specialty/private-lessons.png',
	...
	'parent-child-swim-lessons': {
		...
		icon: '/icons/specialty/parent-child.png',
	...
	'adult-swim-lessons': {
		...
		icon: '/icons/specialty/adult-teen.png',
	...
	'competitive-swim-lessons': {
		...
		icon: '/icons/specialty/competitive.png',
	...
	'survival-swim-lessons': {
		...
		icon: '/icons/specialty/survival-swim.png',
	...
	'special-needs-swim-lessons': {
		...
		icon: '/icons/specialty/adaptive.png',
	...
	'at-home-swim-lessons': {
		...
		icon: '/icons/specialty/mobile.png',
